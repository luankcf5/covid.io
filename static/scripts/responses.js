...
function getBotResponse(input) {
    ...
    if (input == "hello" || input == "hi"|| input == "chao"|| input == "xinchao"||
        ...
        return "Bạn có thể khai báo y tế theo liên kết "+'<a href ="http://localhost/convid-master/khaibao.php"><u> tại đây.</u></a>';
    ...
    // dang ky tiem phong
        ...
        return "Bạn có thể đăng ký tiêm ngừa vacxin tại các cơ sở y tế địa phương hoặc trang tiêm chủng quốc gia https://tiemchungcovid19.gov.vn hoặc có thể đăng ký "+ '<a href ="http://localhost/convid-master/tiemphong.php"><u> tại đây.</u></a>';

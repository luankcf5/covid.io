...
<nav>
  <ul>
    ...
    <h4 style="text-align: center;margin-top:20px;margin-bottom:20px;">DANH SÁCH ĐĂNG KÝ TIÊM CHỦNG NHÓM ĐĂNG KÝ TIÊM MŨI 2</h4>
        <table id="myTable" class="table table-striped table-bordered" style="width:100%">
          <thead>
            <tr>
              ...
              <th class="th-sm">Ngày tiêm mũi 1</th>
              <th class="th-sm">Vacxin tiêm mũi 1</th>
          ...
          <?php
            $stt = 1 ;
            $sql = "SELECT * FROM dang_ky_tiem_phong where Mui_tiem='Đăng ký tiêm mũi thứ hai'";
          ...
          ?>
            <tr>
              ...
              <td class="td-sm"><?php echo $data["Ngay_tiem_mui1"]; ?></td>
              <td class="td-sm"><?php echo $data["Loai_vacxin_mui1"]; ?></td>

...
<nav>
  <ul>
    ...
    <h4 style="text-align: center;margin-top:20px;margin-bottom:20px;">DANH SÁCH ĐĂNG KÝ TIÊM CHỦNG NHÓM NGƯỜI ƯU TIÊN CAO (TỪ 1 ĐẾN 9)</h4>
        <table id="myTable" class="table table-striped table-bordered" style="width:100%">
          ...
          <?php
            $stt = 1 ;
            $sql = "SELECT * FROM dang_ky_tiem_phong where Nhom_uu_tien = '1' or Nhom_uu_tien = '2' or Nhom_uu_tien = '3' or Nhom_uu_tien = '4' or Nhom_uu_tien = '5' or Nhom_uu_tien = '6' or Nhom_uu_tien = '7' or Nhom_uu_tien = '8' or Nhom_uu_tien = '9'";

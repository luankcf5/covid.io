...
<nav>
  <ul>
    ...
    <h4 style="text-align: center;margin-top:20px;margin-bottom:20px;">DANH SÁCH ĐĂNG KÝ TIÊM CHỦNG NHÓM NGƯỜI CÓ TIỀN SỬ MẮC BỆNH</h4>
        <table id="myTable" class="table table-striped table-bordered" style="width:100%">
          ...
          <?php
            $stt = 1 ;
            $sql = "SELECT * FROM dang_ky_tiem_phong where Tiensubenh_phanve ='Có' or Tiensubenh_covid ='Có' or Tiensu_tiemvacxin ='Có' or Tiensubenh_suygiammiendich ='Có' or Su_dung_thuoc_corticoid ='Có' or Tiensubenh_captinh ='Có' or Tiensubenh_mantinh ='Có' or Tiensubenh_mantinh_dadieutri ='Có' or Dang_mang_thai ='Có' or Do_tuoi_tren_65 ='Có' or Tiensubenh_dongmau	 ='Có' or Tiensubenh_diung ='Có'";
